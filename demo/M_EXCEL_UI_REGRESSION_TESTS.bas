...
'
' WHY THIS EXISTS
'   UI_SetExcelUI_WithResult mirrors the best-effort application behavior of
'   UI_SetExcelUI but returns:
    ...
    'Restore TitleBar first when its original state was captured successfully.
        If TitleBarKnown Then
            ...
            'Restore TitleBar via the public API.
                UI_SetExcelUI TitleBar:=TST_TitleBarMode(True, IIf(TitleBarVisible, UI_Show, UI_Hide))
